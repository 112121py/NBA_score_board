...
public class oddview {
	public String date;
	public ArrayList<ArrayList<String>> inform = new ArrayList();
	public ArrayList<String> gaming = new ArrayList();
	public boolean isclick = false;
	public int gamechose;
	public int temp2;
	public int yourmoney;
	public int allyourmoney;
...
//			int cc;
//			cc=paychoose(temp2);
//			totalmoney += yourmoney*(finaloddrec.get(gamechose-1)[(int)(temp2/4)][cc]-1);
...
//			totalmoney += finaloddrec.get(gamechoose-1)[(int)(t/4)][cc]-1;
//		}
		// int t=s.nextInt();
		int cc=paychoose(temp2);
		// finalmoney+=finaloddrec.get(gamechose-1)[(int)(t/4)][cc]-1;
		System.out.print("this round : ");
		System.out.println(finaloddrec.get(gamechose-1)[(int)(temp2/4)][cc]-1);
		totalmoney += finaloddrec.get(gamechose-1)[(int)(temp2/4)][cc]-1;
		System.out.println("this round total : " + totalmoney);
	...
	// 把static拿掉ㄌ
	 ArrayList <double[][]> finaloddrec=new ArrayList <double[][]>();
	 ArrayList <String []> finalteamrec=new ArrayList <String []>();
	
	public void main() throws IOException
	{
		String url="https://www.playsport.cc/predictgame.php?action=scale&allianceid=3&gametime=" + date + "&sid=0";
	            	...
	            	if (gamecnt==-1) {
	            		...
	            		if (cnt==8) {
	            			...
	            			for(int i=0;i<2;i++) {
	            				...
	            				gaming.add(teamrec[i]);
	            				temp.add(teamrec[i]);
	            				for(int j=0;j<5;j++) {
	            					System.out.print(oddsrec[i][j]+" ");
	            					temp.add((oddsrec[i][j])+"");
	            				}
	            				System.out.println();
	            			}
	            		}
